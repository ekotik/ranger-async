...
# This configuration file is licensed under the same terms as ranger-async.
# ===================================================================
#
# NOTE: If you copied this file to /etc/ranger-async/commands_full.py or
# ~/.config/ranger-async/commands_full.py, then it will NOT be loaded by ranger-async,
# and only serve as a reference.
#
# ===================================================================
# This file contains ranger-async's commands.
# It's all in python; lines beginning with # are comments.
#
# Note that additional commands are automatically generated from the methods
# of the class ranger_async.core.actions.Actions.
#
# You can customize commands in the files /etc/ranger-async/commands.py (system-wide)
# and ~/.config/ranger-async/commands.py (per user).
# They have the same syntax as this file.  In fact, you can just copy this
# file to ~/.config/ranger-async/commands_full.py with
# `ranger-async --copy-config=commands_full' and make your modifications, don't
# forget to rename it to commands.py.  You can also use
# `ranger-async --copy-config=commands' to copy a short sample commands.py that
# has everything you need to get started.
# But make sure you update your configs when you update ranger-async.
#
# ===================================================================
# Every class defined here which is a subclass of `Command' will be used as a
# command in ranger-async.  Several methods are defined to interface with ranger-async:
...
#
# ===================================================================
# And this is a little reference for common ranger-async functions and objects:
#
...
# self.fm.execute_console(string): Execute the string as a ranger-async command.
        ...
        while True:
            ...
            for path in paths:
                try:
                    ...
                    continue
                matches += [
                    os.path.join(path, d) for d in directories if self._tab_match(token, d)
                ]
...
class open_with(Command):
    ...
    @staticmethod
    def _is_flags(arg):
        from ranger_async.core.runner import ALLOWED_FLAGS
...
class set_(Command):
    ...
    def tab(self, tabnum):  # pylint: disable=too-many-return-statements
        from ranger_async.gui.colorscheme import get_all_colorschemes
...
class terminal(Command):
    ...
    def execute(self):
        from ranger_async.ext.get_executables import get_term
...
class eval_(Command):
    ...
    def execute(self):
        # The import is needed so eval() can access the ranger-async module
        import ranger_async  # NOQA pylint: disable=unused-import,unused-variable
...
class bulkrename(Command):
    ...
    def execute(self):
        ...
        from ranger_async.container.file import File
        from ranger_async.ext.shell_escape import shell_escape as esc
...
class help_(Command):
    ...
    Display ranger-async's manual page.
    """
...
class filter_stack(Command):
    ...
    def execute(self):
        from ranger_async.core.filter_stack import FILTER_COMBINATORS, SIMPLE_FILTERS
...
class stage(Command):
    ...
    def execute(self):
        from ranger_async.ext.vcs import VcsError
...
class linemode(default_linemode):
    ...
    - "mode" may be any of the defined linemodes (see: ranger_async.core.linemode).
    ...
    def execute(self):
        ...
        if mode == "normal":
            from ranger_async.core.linemode import DEFAULT_LINEMODE
