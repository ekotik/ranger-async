# Compatible since ranger-async 1.7.0 (git commit c82a8a76989c)
#
...
ACCEPT_FILE_OLD = ranger_async.container.directory.accept_file
...
ranger_async.container.directory.accept_file = custom_accept_file
